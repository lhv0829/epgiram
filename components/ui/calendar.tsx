  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        table: "w-full border-collapse space-y-1 border-y",
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md h-11 w-11 md:h-[54px] md:w-[54px] lg:w-[91px] lg:h-[91px] font-normal text-[0.8rem]",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-11 w-11 md:h-[54px] md:w-[54px] lg:w-[91px] lg:h-[91px] p-0 font-normal aria-selected:opacity-100"),
